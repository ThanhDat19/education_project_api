    ...
    <form action="" method="post">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="option_text" class="form-control" placeholder="Nhập nội dung lựa chọn">
            </div>

            <div class="form-group">
                <label for="option">Đáp án đúng</label>
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-primary">Thêm lựa chọn</button>
        </div>
    </form>
@endsection
@section('footer')
